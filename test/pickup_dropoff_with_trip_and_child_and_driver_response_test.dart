...
// tests for PickupDropoffWithTripAndChildAndDriverResponse
void main() {
    var instance = new PickupDropoffWithTripAndChildAndDriverResponse();

  group('test PickupDropoffWithTripAndChildAndDriverResponse', () {
