...
class PickupDropoffResponse {
  ...
  static PickupDropoffResponse fromJson(Map<String, dynamic> json) => json == null
    ? null
    : PickupDropoffResponse(
        id: json[r'id'] == null ?
          null :
  ...
  static List<PickupDropoffResponse> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <PickupDropoffResponse>[]
      : json.map((v) => PickupDropoffResponse.fromJson(v)).toList(growable: true == growable);

  static Map<String, PickupDropoffResponse> mapFromJson(Map<String, dynamic> json) {
    final map = <String, PickupDropoffResponse>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = PickupDropoffResponse.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of PickupDropoffResponse-objects as value to a dart map
  static Map<String, List<PickupDropoffResponse>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<PickupDropoffResponse>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = PickupDropoffResponse.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
