...
class CreateGroupBody {
  ...
  @override
  String toString() => 'CreateGroupBody[name=$name, schoolId=$schoolId, toTime=$toTime, monthFees=$monthFees, threeMonthsFees=$threeMonthsFees, sixMonthsFees=$sixMonthsFees, twelveMonthsFees=$twelveMonthsFees, fromTime=$fromTime, updateChildFees=$updateChildFees]';
