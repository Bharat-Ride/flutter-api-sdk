...
class UserApi {
  ...
  Future<Response> userPutWithHttpInfo(UpdateUserWithAddressBody updateUserWithAddressBody) async {
  ...
  ///
  /// Update a user as driver and/or parent
  Future<UpdateRecordsResponse> userPut(UpdateUserWithAddressBody updateUserWithAddressBody) async {
    Response response = await userPutWithHttpInfo(updateUserWithAddressBody);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
